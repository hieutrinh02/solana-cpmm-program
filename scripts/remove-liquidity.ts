...
function createRemoveLiquidityInstruction(args: {
    programId: PublicKey;
    payer: PublicKey;
    pair: PublicKey;
    mint0: PublicKey;
...
async function main(): Promise<void> {
    ...
    const lpDecimals = 6;
    const liquidityToBurn = BigInt(100 * (10 ** lpDecimals));
    const amount0Min = 0n;
    const amount1Min = 0n;
    ...
    console.log(`Mint0: ${mint0.toBase58()}`);
    console.log(`Mint1: ${mint1.toBase58()}`);
    ...
    console.log(`Liquidity to burn: ${liquidityToBurn.toString()}`);
    console.log(`Amount0 min: ${amount0Min.toString()}`);
    console.log(`Amount1 min: ${amount1Min.toString()}`);
    console.log(`RemoveLiquidity signature: ${signature}`);
}
